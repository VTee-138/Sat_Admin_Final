...
export default function UserForm({
  ...
  // Helper function to convert date value to dayjs object
  ...
  const handleDatePickerChange = (name) => (newValue) => {
    ...
    handleChangeInputUser(syntheticEvent);
  };
      ...
      <div className="py-4 sm:py-6 max-w-4xl mx-auto bg-white shadow-lg rounded-lg mb-6 sm:mb-8 px-[6rem]">
        ...
        <div className="mb-4 sm:mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <DatePicker
            ...
            value={parseDateValue(formData?.expectedEndDate)}
            onChange={handleDatePickerChange("expectedEndDate")}
            format="DD/MM/YYYY"
            slotProps={{
              textField: {
                variant: "standard",
          ...
          <DatePicker
            ...
            value={parseDateValue(formData?.expectedExamDate)}
            onChange={handleDatePickerChange("expectedExamDate")}
            format="DD/MM/YYYY"
            slotProps={{
              textField: {
                variant: "standard",
