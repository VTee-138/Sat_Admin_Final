      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6 rounded-t-xl">
          <h1 className="text-2xl sm:text-3xl font-bold text-white text-center">
            {isEditing ? "✏️ Chỉnh sửa câu hỏi" : "📝 Tạo câu hỏi mới"}
          </h1>
        ...
        <div className="p-8 space-y-8">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-1 gap-6">
                <TextField
                  ...
                  helperText={errors.subject ? "Vui lòng chọn môn học" : ""}
                >
                  <MenuItem value="">Chọn môn học</MenuItem>
                  {["MATH", "ENGLISH"].map((option, key) => (
                    <MenuItem key={key} value={option}>
                      {option === "MATH" ? "Toán học" : "Tiếng Anh"}
                    </MenuItem>
                  ))}
                </TextField>
              </div>
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 space-y-6">
              ...
              {/* Difficulty and Question Type Fields */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <TextField
                  select
                  label="Độ khó"
                  ...
                  InputLabelProps={{ shrink: true }}
                >
                  {["EASY", "MEDIUM", "HARD"].map((option, key) => (
                    <MenuItem key={key} value={option}>
                      {option === "EASY"
                        ? "Dễ"
                        : option === "MEDIUM"
                ...
                <TextField
                  ...
                  variant="outlined"
                  InputLabelProps={{ shrink: true }}
                  placeholder="Ví dụ: Algebra;Linear equations"
                  helperText="Nhập loại câu hỏi (có thể dùng dấu ; để phân cách cha con)"
                />
              </div>
